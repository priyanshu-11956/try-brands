  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        glow: "relative bg-gradient-to-r from-blue-400 to-violet-500 text-white shadow-lg hover:shadow-primary/50 transition-shadow duration-300",
        gradient: "gradient-border hover:scale-[1.02] transition-transform duration-300",
      },
      size: {
